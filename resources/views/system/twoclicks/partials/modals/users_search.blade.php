                        ...
                        <div class="py-5">
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic"
                                                src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-6.jpg') }}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Info-->
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic"
                                                src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-1.jpg') }}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Info-->
                                        <div class="fw-semibold">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic"
                                                src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-5.jpg') }}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Info-->
                                        <div class="fw-semibold">
                                    ...
                                    <a href="#"
                                        ...
                                        <div class="symbol symbol-35px symbol-circle me-5">
                                            <img alt="Pic"
                                                src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-25.jpg') }}" />
                                        </div>
                                        <!--end::Avatar-->
                                        <!--begin::Info-->
                                        <div class="fw-semibold">
                                ...
                                <div class="mh-375px scroll-y me-n7 pe-7">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="6">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic"
                                                    src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-9.jpg') }}" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Details-->
                                            <div class="ms-5">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="9">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic"
                                                    src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-23.jpg') }}" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Details-->
                                            <div class="ms-5">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="11">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic"
                                                    src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-12.jpg') }}" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Details-->
                                            <div class="ms-5">
                                    ...
                                    <div class="rounded d-flex flex-stack bg-active-lighten p-4" data-user-id="15">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="symbol symbol-35px symbol-circle">
                                                <img alt="Pic"
                                                    src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-21.jpg') }}" />
                                            </div>
                                            <!--end::Avatar-->
                                            <!--begin::Details-->
                                            <div class="ms-5">
                            ...
                            <div data-kt-search-element="empty" class="text-center d-none">
                                ...
                                <div class="text-center px-5">
                                    <img src="{{ asset('system/metronic8/demo34/assets/media/illustrations/sketchy-1/1.png') }}"
