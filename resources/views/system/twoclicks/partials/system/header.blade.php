<div id="kt_app_header" class="app-header" data-kt-sticky="true" data-kt-sticky-activate="{default: false, lg: true}"
    ...
    <div class="app-container container-xxl d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0 me-lg-18">
            <a href="index.html">
                <img alt="Logo" src="{{ asset('system/metronic8/demo34/assets/media/logos/demo34-small.svg') }}"
                    class="h-25px d-sm-none" />
                <img alt="Logo" src="{{ asset('system/metronic8/demo34/assets/media/logos/demo34.png') }}"
                                ...
                                <div class="tab-content py-4 py-lg-8 px-lg-7">
                                    ...
                                    <div class="tab-pane active w-lg-1000px" id="kt_app_header_menu_pages_pages">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-4">
                                                <img src="{{ asset('system/metronic8/demo34/assets/media/stock/600x600/img-82.jpg') }}"
                                    ...
                                    <div class="tab-pane w-lg-600px" id="kt_app_header_menu_pages_account">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-7">
                                                <img src="{{ asset('system/metronic8/demo34/assets/media/stock/900x600/46.jpg') }}"
                                                    class="rounded mw-100" alt="" />
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                    ...
                                    <div class="tab-pane w-lg-1000px" id="kt_app_header_menu_pages_utilities">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-5 pe-lg-5">
                                                <img src="{{ asset('system/metronic8/demo34/assets/media/stock/600x600/img-84.jpg') }}"
                                                    class="rounded mw-100" alt="" />
                                            </div>
                                            <!--end:Col-->
                                        </div>
                                    ...
                                    <div class="tab-pane w-lg-500px" id="kt_app_header_menu_pages_widgets">
                                        ...
                                        <div class="row">
                                            ...
                                            <!--begin:Col-->
                                            <div class="col-lg-8">
                                                <img src="{{ asset('system/metronic8/demo34/assets/media/stock/900x600/44.jpg') }}"
                                                    class="rounded mw-100" alt="" />
                                            </div>
                                            <!--end:Col-->
                                        </div>
                    ...
                    <div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
                        ...
                        <div
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link"
                                    href="https://preview.keenthemes.com/metronic8/demo34/layout-builder.html"
                ...
                <div class="app-navbar-item ms-1 ms-lg-5">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true"
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                            style="background-image:url('{{ asset('system/metronic8/demo34/assets/media/misc/menu-header-bg.jpg') }}">
                            <!--begin::Title-->
                                ...
                                <div class="d-flex flex-column px-9">
                                    ...
                                    <div class="text-center px-4">
                                        <img class="mw-100 mh-200px" alt="image"
                                            src="{{ asset('system/metronic8/demo34/assets/media/illustrations/sketchy-1/1.png') }}" />
                                    </div>
                                    <!--end::Illustration-->
                                </div>
                                <!--end::Wrapper-->
                ...
                <div class="app-navbar-item ms-5" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px symbol-md-40px"
                        ...
                        <img class="symbol symbol-circle symbol-35px symbol-md-40px"
                            src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-13.jpg') }}"
                            alt="user" />
                    </div>
                                ...
                                <span class="menu-title position-relative">Language
                                    <span
                                        ...
                                        <img class="w-15px h-15px rounded-1 ms-2"
                                            src="{{ asset('system/metronic8/demo34/assets/media/flags/united-states.svg') }}"
                                            alt="" /></span></span>
                            </a>
                            <!--begin::Menu sub-->
                            <div class="menu-sub menu-sub-dropdown w-175px py-4">
                                ...
                                <div class="menu-item px-3">
                                    <a href="account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="{{ asset('system/metronic8/demo34/assets/media/flags/spain.svg') }}"
                                                alt="" />
                                        </span>Spanish</a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <div class="menu-item px-3">
                                    <a href="account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="{{ asset('system/metronic8/demo34/assets/media/flags/germany.svg') }}"
                                                alt="" />
                                        </span>German</a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <div class="menu-item px-3">
                                    <a href="account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="{{ asset('system/metronic8/demo34/assets/media/flags/japan.svg') }}"
                                                alt="" />
                                        </span>Japanese</a>
                                </div>
                                <!--end::Menu item-->
                                ...
                                <div class="menu-item px-3">
                                    <a href="account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1"
                                                src="{{ asset('system/metronic8/demo34/assets/media/flags/france.svg') }}"
                                                alt="" />
                                        </span>French</a>
                                </div>
                                <!--end::Menu item-->
