...
<html lang="en">
<!--begin::Head-->
@include('system.twoclicks.partials.head')
<!--end::Head-->
<!--begin::Body-->

<body id="kt_app_body" data-kt-app-header-fixed-mobile="true" data-kt-app-toolbar-enabled="true" class="app-default">
    <!--begin::Theme mode setup on page load-->
    @include('system.twoclicks.partials.theme')
    ...
    <div class="d-flex flex-column flex-root app-root" id="kt_app_root">
        ...
        <div class="app-page flex-column flex-column-fluid" id="kt_app_page">
            <!--begin::Header-->
            @include('system.twoclicks.partials.header')
            <!--end::Header-->
            <!--begin::Wrapper-->
            <div class="app-wrapper flex-column flex-row-fluid" id="kt_app_wrapper">
                <!--begin::Toolbar-->
                @include('system.twoclicks.partials.toolbar')
                <!--end::Toolbar-->
                                ...
                                <div class="row g-5 g-xl-8">
                                        ...
                                        <div class="row mb-5 mb-xl-8 g-5 g-xl-8">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <a class="card flex-column justfiy-content-start align-items-start text-start w-100 text-gray-800 text-hover-primary p-10"
                                                    ...
                                                    <i
                                                        class="ki-outline ki-technology-2 fs-2tx mb-5 ms-n1 text-gray-500"></i>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <a class="card flex-column justfiy-content-start align-items-start text-start w-100 text-gray-800 text-hover-primary p-10"
                                                    ...
                                                    <i
                                                        class="ki-outline ki-fingerprint-scanning fs-2tx mb-5 ms-n1 text-gray-500"></i>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <a class="card flex-column justfiy-content-start align-items-start text-start w-100 text-gray-800 text-hover-primary p-10"
                                                    ...
                                                    <i
                                                        class="ki-outline ki-abstract-26 fs-2tx mb-5 ms-n1 text-gray-500"></i>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <a class="card flex-column justfiy-content-start align-items-start text-start w-100 text-gray-800 text-hover-primary p-10"
                                                    ...
                                                    <i
                                                        class="ki-outline ki-basket fs-2tx mb-5 ms-n1 text-gray-500"></i>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <a class="card flex-column justfiy-content-start align-items-start text-start w-100 text-gray-800 text-hover-primary p-10"
                                                    ...
                                                    <i
                                                        class="ki-outline ki-rocket fs-2tx mb-5 ms-n1 text-gray-500"></i>
                                        ...
                                        <div class="card mb-5 mb-xl-8">
                                            ...
                                            <div class="card-header align-items-center border-0 mt-4">
                                                ...
                                                <div class="card-toolbar">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px"
                                                        data-kt-menu="true" id="kt_menu_685c7c6476572">
                                                        <!--begin::Header-->
                                                        <div class="px-7 py-5">
                                                            ...
                                                            <div class="mb-10">
                                                                ...
                                                                <div>
                                                                    <select class="form-select form-select-solid"
                                                                        ...
                                                                        data-dropdown-parent="#kt_menu_685c7c6476572"
                                            ...
                                            <div class="card-body pt-5">
                                                ...
                                                <div class="timeline-label">
                                                    ...
                                                    <div class="timeline-item">
                                                        <!--begin::Label-->
                                                        <div class="timeline-label fw-bold text-gray-800 fs-6">16:50
                                                        </div>
                                                        <!--end::Label-->
                                                        <!--begin::Badge-->
                                                        <div class="timeline-badge">
                                                    ...
                                                    <div class="timeline-item">
                                                        <!--begin::Label-->
                                                        <div class="timeline-label fw-bold text-gray-800 fs-6">21:03
                                                        </div>
                                                        <!--end::Label-->
                                                        <!--begin::Badge-->
                                                        <div class="timeline-badge">
                                                    ...
                                                    <div class="timeline-item">
                                                        <!--begin::Label-->
                                                        <div class="timeline-label fw-bold text-gray-800 fs-6">10:30
                                                        </div>
                                                        <!--end::Label-->
                                                        <!--begin::Badge-->
                                                        <div class="timeline-badge">
                                            ...
                                            <div class="card-header py-7">
                                                ...
                                                <div class="m-0">
                                                    ...
                                                    <div class="d-flex align-items-center mb-2">
                                                        ...
                                                        <span class="badge badge-light-danger fs-base">
                                                            <i
                                                                class="ki-outline ki-arrow-up fs-5 text-danger ms-n1"></i>8.02%</span>
                                                        <!--end::Badge-->
                                                    </div>
                                                    <!--end::Heading-->
                                                    <!--begin::Description-->
                                                    <span class="fs-6 fw-semibold text-gray-500">Online store
                                                ...
                                                <div class="card-toolbar">
                                                    ...
                                                    <button
                                                        ...
                                                        <i
                                                            class="ki-outline ki-dots-square fs-1 text-gray-500 me-n1"></i>
                                                    </button>
                                                    <!--begin::Menu 2-->
                                    ...
                                    <div class="col-xl-8 ps-xl-12">
                                        ...
                                        <div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px bg-body mb-5 mb-xl-8"
                                            style="background-position: 100% 50px;background-size: 500px auto;background-image:url('{{ asset('system/metronic8/demo34/assets/media/misc/city.png') }}')"
                                            dir="ltr">
                                            <!--begin::Body-->
                                                    ...
                                                    <div class="card-header pt-5">
                                                        ...
                                                        <div class="card-toolbar">
                                                            ...
                                                            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold w-200px py-3"
                                                                ...
                                                                <div class="menu-item px-3">
                                                                    <a href="#"
                                                                        class="menu-link flex-stack px-3">Create
                                                                        Payment
                                                                        <span class="ms-2"
                                                                            data-bs-toggle="tooltip"
                                                                            title="Specify a target name for future usage and reference">
                                                                            <i
                                                                                class="ki-outline ki-information fs-6"></i>
                                                                        </span></a>
                                                                </div>
                                                                <!--end::Menu item-->
                                                                <!--begin::Menu item-->
                                                        ...
                                                        <div class="m-0">
                                                                ...
                                                                <div class="d-flex align-items-center me-2">
                                                                    ...
                                                                    <div class="symbol symbol-50px me-5">
                                                                        <div class="symbol-label bg-light">
                                                                            <img src="{{ asset('system/metronic8/demo34/assets/media/svg/brand-logos/plurk.svg') }}"
                                                                                class="h-50" alt="" />
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Symbol-->
                                                            ...
                                                            <div class="d-flex flex-stack mb-9">
                                                                ...
                                                                <div class="d-flex align-items-center me-2">
                                                                    ...
                                                                    <div class="symbol symbol-50px me-5">
                                                                        <div class="symbol-label bg-light">
                                                                            <img src="{{ asset('system/metronic8/demo34/assets/media/svg/brand-logos/telegram-2.svg') }}"
                                                                                class="h-50" alt="" />
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Symbol-->
                                                            ...
                                                            <div class="d-flex flex-stack">
                                                                ...
                                                                <div class="d-flex align-items-center me-2">
                                                                    ...
                                                                    <div class="symbol symbol-50px me-5">
                                                                        <div class="symbol-label bg-light">
                                                                            <img src="{{ asset('system/metronic8/demo34/assets/media/svg/brand-logos/vimeo.svg') }}"
                                                                                class="h-50" alt="" />
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Symbol-->
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="symbol symbol-45px me-2">
                                                                                <span class="symbol-label">
                                                                                    <img src="{{ asset('system/metronic8/demo34/assets/media/svg/brand-logos/telegram.svg') }}"
                                                                                        class="h-50 align-self-center"
                                                                                        alt="" />
                                                                                </span>
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="symbol symbol-45px me-2">
                                                                                <span class="symbol-label">
                                                                                    <img src="{{ asset('system/metronic8/demo34/assets/media/svg/brand-logos/bebo.svg') }}"
                                                                                        class="h-50 align-self-center"
                                                                                        alt="" />
                                                                                </span>
                                                                            </div>
                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div class="symbol symbol-45px me-2">
                                                                                <span class="symbol-label">
                                                                                    <img src="{{ asset('system/metronic8/demo34/assets/media/svg/brand-logos/kickstarter.svg') }}"
                                                                                        class="h-50 align-self-center"
                                                                                        alt="" />
                                                                                </span>
                                                                            </div>
                                                ...
                                                <div class="card h-xl-100 mb-xl-8">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="d-flex flex-stack">
                                                            ...
                                                            <div class="d-flex align-items-center">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <a href="#"
                                                                        class="text-gray-900 fw-bold text-hover-primary fs-5">Monthly
                                                                        Subscription</a>
                                                                    <span class="text-muted fw-bold">Due: 27 Apr
                                                                        2020</span>
                                                                </div>
                                                                <!--end:Title-->
                                                            </div>
                                                        ...
                                                        <div class="d-flex flex-column w-100 mt-12">
                                                            <span
                                                                class="text-gray-900 me-2 fw-bold pb-3">Progress</span>
                                                        ...
                                                        <div class="d-flex flex-column mt-10">
                                                            ...
                                                            <div class="d-flex">
                                                                <a href="#" class="symbol symbol-35px me-2"
                                                                    ...
                                                                    <img src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-6.jpg') }}"
                                                                        alt="" />
                                                                </a>
                                                                <a href="#" class="symbol symbol-35px me-2"
                                                                    data-bs-toggle="tooltip" title="Mark Larson">
                                                                    <img src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-5.jpg') }}"
                                                                        alt="" />
                                                                </a>
                                                                <a href="#" class="symbol symbol-35px me-2"
                                                                    data-bs-toggle="tooltip" title="Sam Harris">
                                                                    <img src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-9.jpg') }}"
                                                                        alt="" />
                                                                </a>
                                                                <a href="#" class="symbol symbol-35px"
                                                                    data-bs-toggle="tooltip" title="Alice Micto">
                                                                    <img src="{{ asset('system/metronic8/demo34/assets/media/avatars/300-10.jpg') }}"
                                                                        alt="" />
                                                                </a>
                                                            </div>
                                                        </div>
    ...
    @include('system.twoclicks.partials.drawers.activities')
    <!--end::Activities drawer-->
    <!--begin::Chat drawer-->
    @include('system.twoclicks.partials.drawers.chat')
    <!--end::Chat drawer-->
    <!--begin::shooping drawer-->
    @include('system.twoclicks.partials.drawers.shooping')
    <!--end::shooping drawer-->
    <!--end::Drawers-->
    <!--begin::Scrolltop-->
    @include('system.twoclicks.partials.drawers.scrolltop')
    <!--end::Scrolltop-->
    <!--begin::Modals-->
    <!--begin::Modal - Upgrade plan-->
    @include('system.twoclicks.partials.modals.upgrade-plan')
    <!--end::Modal - Upgrade plan-->
    <!--begin::Modal - Invite Friends-->
    @include('system.twoclicks.partials.modals.invite_friends')
    <!--end::Modal - Invite Friend-->
    <!--begin::Modal - New Target-->
    @include('system.twoclicks.partials.modals.new_target')
    <!--end::Modal - New Target-->
    <!--begin::Modal - Create App-->
    @include('system.twoclicks.partials.modals.create_app')
    <!--end::Modal - Create App-->
    <!--begin::Modal - Users Search-->
    @include('system.twoclicks.partials.modals.users_search')
    <!--end::Modal - Users Search-->
    <!--end::Modals-->
    <!--begin::Javascript-->
    @include('system.twoclicks.partials.footer')
</body>
<!--end::Body-->
