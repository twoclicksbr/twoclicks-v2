        ...
        <div class="d-flex flex-column flex-lg-row-fluid w-lg-50 p-10 order-2 order-lg-1">
            ...
            <div class="w-lg-500px d-flex flex-stack px-10 mx-auto">
                <div class="text-gray-500 fw-semibold fs-7">
                    ...
                    <a href="https://twoclicks.com.br" target="_blank" class="text-gray-800 text-hover-primary d-inline-flex align-items-center gap-1 ms-1">
        ...
        <div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2"
            ...
            <div class="d-flex flex-column flex-center py-7 py-lg-15 px-5 px-md-15 w-100">
                ...
                <a href="{{ url('/') }}" class="mb-0 mb-lg-12">
                    <img alt="TwoClicks" src="{{ asset('system/metronic8/demo34/assets/media/logos/logo-tc-light.svg') }}" class="h-60px h-lg-75px" />
                </a>
                <!--end::Logo-->
                <!--begin::Image-->
                ...
                <!--end::Image-->
                <!--begin::Title-->
                <h1 class="d-none d-lg-block text-white fs-2qx fw-bolder text-center mb-7">Gerencie suas plataformas em um só lugar</h1>
                <!--end::Title-->
                <!--begin::Text-->
