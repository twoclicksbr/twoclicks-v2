                                    ...
                                    <div class="mb-10">
                                        ...
                                        <div>
                                            <select class="form-select form-select-solid" multiple="multiple"
                                                ...
                                                data-dropdown-parent="#kt_menu_685c7c6476572" data-allow-clear="true">
                                                <option></option>
            ...
            <div class="col-xl-8 ps-xl-12">
                ...
                <div class="card bgi-position-y-bottom bgi-position-x-end bgi-no-repeat bgi-size-cover min-h-250px bg-body mb-5 mb-xl-8"
                    ...
                    <div class="card-body d-flex flex-column justify-content-center ps-lg-12">
                        ...
                        <!--begin::Action-->
                        <div class="m-0">
                            <a href='#' class="btn btn-dark fw-semibold px-6 py-3" data-bs-toggle="modal"
                            ...
                            <div class="card-body d-flex justify-content-between flex-column pt-0">
                                ...
                                <div class="m-0">
                                    ...
                                    <div class="d-flex flex-stack mb-9">
                                        ...
                                        <!--end::Section-->
                                        <!--begin::Label-->
                                        <div class="badge badge-light badge-lg fw-bold p-2 text-gray-600">
                                            +82$</div>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Item-->
